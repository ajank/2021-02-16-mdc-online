...
latitude: "52.526259"        # decimal latitude of workshop venue (use https://www.latlong.net/)
longitude: "13.385371"       # decimal longitude of the workshop venue (use https://www.latlong.net)
humandate: "Feb 16-19, 2021"    # human-readable dates for the workshop (e.g., "Feb 17-18, 2020")
...
instructor: ["Monah Abou Alezz", "Tobias Busch", "Liz Ing-Simmons", "Aleksander Jankowski"] # boxed, comma-separated list of instructors' names as strings, like ["Kay McNulty", "Betty Jennings", "Betty Snyder"]
helper: ["Harithaa Anandakumar", "Aleix Arnau Soler", "Kerstin Haase"]     # boxed, comma-separated list of helpers' names, like ["Marlyn Wescoff", "Fran Bilas", "Ruth Lichterman"]
email: ["Hanna.Singer@mdc-berlin.de", "ajank@mimuw.edu.pl"]    # boxed, comma-separated list of contact email addresses for the host, lead instructor, or whoever else is handling questions, like ["marlyn.wescoff@example.org", "fran.bilas@example.org", "ruth.lichterman@example.org"]
collaborative_notes: "https://pad.carpentries.org/2021-02-16-mdc-online" # optional: URL for the workshop collaborative notes, e.g. an Etherpad or Google Docs document (e.g., https://pad.carpentries.org/2015-01-01-euphoria)
